...
const Home = () => {
  ...
  useEffect(() => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=30e4377b44485e2eca245f776448135429280dd0&country=IN&year=${year}`
    )
      .then(res => {
  ...
  const handlePreviousHoliday = pyear => {
    setYear(pyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=30e4377b44485e2eca245f776448135429280dd0&country=IN&year=${pyear}`
    )
      .then(res => {
        res.json().then(result => {
          setMyHoliday(result.response.holidays);
  ...
  const handleNextHoliday = nyear => {
    setYear(nyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=30e4377b44485e2eca245f776448135429280dd0&country=IN&year=${nyear}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
  ...
  const handleHolidayDetail = (day, month, year) => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=30e4377b44485e2eca245f776448135429280dd0&country=IN&year=${year}&day=${day}&month=${month}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
