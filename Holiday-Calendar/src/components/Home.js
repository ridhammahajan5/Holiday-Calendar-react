...
const Home = () => {
  ...
  useEffect(() => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=6e0f7c84f994a95662c9d4028a0dec4e8a3f8f39&country=IN&year=${year}`
    )
      .then(res => {
  ...
  const handlePreviousHoliday = pyear => {
    setYear(pyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=6e0f7c84f994a95662c9d4028a0dec4e8a3f8f39&country=IN&year=${pyear}`
    )
      .then(res => {
        res.json().then(result => {
          setMyHoliday(result.response.holidays);
  ...
  const handleNextHoliday = nyear => {
    setYear(nyear);
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=6e0f7c84f994a95662c9d4028a0dec4e8a3f8f39&country=IN&year=${nyear}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
  ...
  const handleHolidayDetail = (day, month, year) => {
    fetch(
      `https://calendarific.com/api/v2/holidays?api_key=6e0f7c84f994a95662c9d4028a0dec4e8a3f8f39&country=IN&year=${year}&day=${day}&month=${month}`
    )
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
